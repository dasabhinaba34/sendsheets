    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={`w-full bg-white/5 border rounded-lg px-4 py-2.5 text-sm text-white placeholder-white/20 focus:outline-none transition-colors ${
            activeField === 'subject' ? 'border-green-500/50' : 'border-white/10'
          }`}
        />
      </div>
      <div className="space-y-1.5">
        <label className="text-sm font-medium text-white/70">Body</label>
        <RichTextEditor
          value={body}
